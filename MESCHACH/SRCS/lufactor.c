...
extern  MAT	*LUfactor(MAT *A, PERM *pivot)
{
...
extern  VEC	*LUsolve(MAT *A, PERM *pivot, VEC *b, VEC *x)
{
...
extern  VEC	*LUTsolve(MAT *LU, PERM *pivot, VEC *b, VEC *x)
{
	if ( ! LU || ! b || ! pivot )
...
extern  double	LUcondest(MAT *LU, PERM *pivot)
{
