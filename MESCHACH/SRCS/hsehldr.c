...
extern  VEC	*hhvec(VEC	*vec, u_int i0, Real *beta, VEC *out, Real *newval)
{
	Real	norm;
...
extern  VEC	*hhtrvec(VEC *hh, double beta, u_int i0, VEC *in, VEC *out)
...
extern  MAT	*hhtrrows(MAT *M, u_int i0, u_int j0, VEC *hh, double beta)
{
	Real	ip, scale;
	int	i /*, j */;
...
/* hhtrcols -- transform a matrix by a Householder vector by columns
	starting at row i0 from column j0 -- in-situ */
extern  MAT	*hhtrcols(MAT *M, u_int i0, u_int j0, VEC *hh, double beta)
{
	/* Real	ip, scale; */
	int	i /*, k */;
	static	VEC	*w = VNULL;
