...
extern  double	_v_norm2(VEC *x, VEC *scale)
{
	int	i, dim;
	Real	s, sum;
...
extern  double	_v_norm_inf(VEC *x, VEC *scale)
{
	int	i, dim;
	Real	s, maxval, tmp;
...
extern  double	m_norm_inf(MAT *A)
{
	int	i, j, m, n;
	Real	maxval, sum;
...
extern  double	m_norm_frob(MAT *A)
{
	int	i, j, m, n;
	Real	sum;
