...
extern  MAT	*m_add(MAT *mat1, MAT *mat2, MAT *out)
{
	u_int	m,n,i;
...
extern  MAT	*m_sub(MAT *mat1, MAT *mat2, MAT *out)
{
	u_int	m,n,i;
...
extern  MAT	*m_mlt(MAT *A, MAT *B, MAT *OUT)
{
	u_int	i, /* j, */ k, m, n, p;
...
extern  MAT	*mmtr_mlt(MAT *A, MAT *B, MAT *OUT)
{
	int	i, j, limit;
...
extern  MAT	*mtrm_mlt(MAT *A, MAT *B, MAT *OUT)
{
	int	i, k, limit;
...
extern  VEC	*mv_mlt(MAT *A, VEC *b, VEC *out)
{
	u_int	i, m, n;
	Real	**A_v, *b_v /*, *A_row */;
	/* register Real	sum; */
...
extern  MAT	*sm_mlt(double scalar, MAT *matrix, MAT *out)
{
	u_int	m,n,i;
...
extern  VEC	*vm_mlt(MAT *A, VEC *b, VEC *out)
{
	u_int	j,m,n;
	/* Real	sum,**A_v,*b_v; */
...
extern  MAT	*m_transp(MAT *in, MAT *out)
{
	int	i, j;
	int	in_situ;
	Real	tmp;
...
extern  MAT	*swap_rows(MAT *A, int i, int j, int lo, int hi)
{
	int	k;
	Real	**A_me, tmp;
...
extern  MAT	*swap_cols(MAT *A, int i, int j, int lo, int hi)
{
	int	k;
	Real	**A_me, tmp;
...
/* ms_mltadd -- matrix-scalar multiply and add
	-- may be in situ
	-- returns out == A1 + s*A2 */
extern  MAT	*ms_mltadd(MAT *A1, MAT *A2, double s, MAT *out)
{
...
extern  VEC	*mv_mltadd(VEC *v1, VEC *v2, MAT *A, double alpha, VEC *out)
{
	/* register	int	j; */
	int	i, m, n;
	Real	*v2_ve, *out_ve;
...
/* vm_mltadd -- vector-matrix multiply and add
	-- may not be in situ
	-- returns out' == v1' + v2'*A */
extern  VEC	*vm_mltadd(VEC *v1, VEC *v2, MAT *A, double alpha, VEC *out)
{
	int	/* i, */ j, m, n;
	Real	tmp, /* *A_e, */ *out_ve;
