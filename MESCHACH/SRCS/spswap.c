...
extern  void	scan_to(SPMAT *A, IVEC *scan_row, IVEC *scan_idx, IVEC *col_list, int max_row)
{
...
extern  row_elt *chase_col(SPMAT	*A, int col, int *row_num, int *idx, int max_row)
{
...
extern  row_elt *chase_past(SPMAT *A, int col, int *row_num, int *idx, int min_row)
{
    SPROW	*r;
    row_elt	*e;
    int		tmp_idx, tmp_row;
...
extern  row_elt *bump_col(SPMAT	*A, int col, int *row_num, int *idx)
{
    SPROW	*r;
    row_elt	*e;
    int		tmp_row, tmp_idx;
