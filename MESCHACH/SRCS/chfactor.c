...
static	char	rcsid[] = "$Id: chfactor.c,v 1.1 2003/08/09 16:25:32 xavier Exp $";
...
extern  VEC	*CHsolve(MAT *A, VEC *b ,VEC *x)
{
...
extern  VEC	*LDLsolve(MAT	*LDL, VEC *b, VEC  *x)
{
	if ( ! LDL || ! b )
...
extern  MAT	*MCHfactor(MAT	*A, double tol)
{
	u_int	i, j, k, n;
	Real	**A_ent, *A_piv, *A_row, sum, tmp;
