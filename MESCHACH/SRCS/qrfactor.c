...
static	char	rcsid[] = "$Id: qrfactor.c,v 1.1 2003/08/09 16:25:32 xavier Exp $";
...
extern  MAT	*QRfactor(MAT *A, VEC *diag)
{
    u_int	k,limit;
    Real	beta;
...
extern  MAT	*QRCPfactor(MAT *A, VEC *diag, PERM *px)
{
...
extern  VEC	*_Qsolve(MAT *QR, VEC *diag, VEC *b, VEC *x, VEC *tmp)
{
    u_int	dynamic;
    int		k, limit;
...
extern  MAT	*makeQ(MAT *QR, VEC *diag, MAT *Qout)
{
...
extern  MAT	*makeR(MAT *QR, MAT *Rout)
{
    u_int	i,j;
...
extern  VEC	*QRsolve(MAT *QR, VEC *diag, VEC *b, VEC *x)
{
    int	limit;
...
extern  VEC	*QRCPsolve(MAT *QR, VEC *diag, PERM *pivot, VEC *b, VEC *x)
{
    static	VEC	*tmp=VNULL;
...
extern  VEC *QRTsolve(MAT *A, VEC *diag, VEC *c, VEC *sc)
{
    int		i, j, k, n, p;
...
extern  double	QRcondest(MAT *QR)
{
    static	VEC	*y=VNULL;
