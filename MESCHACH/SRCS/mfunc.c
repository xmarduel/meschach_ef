...
extern  MAT	*_m_pow(MAT *A, int p, MAT *tmp, MAT *out)
{
...
extern  MAT	*m_pow(MAT *A, int p, MAT *out)
{
...
*/
extern  MAT *_m_exp(MAT *A, double eps, MAT *out, int *q_out, int *j_out)
{
...
extern  MAT *m_exp(MAT *A, double eps, MAT *out)
{
   int q_out, j_out;
...
extern  MAT *m_poly(MAT *A, VEC *a, MAT *out)
{
