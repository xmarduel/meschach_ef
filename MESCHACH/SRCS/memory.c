...
extern  int m_get_vars(int m,int n,...) 
{
   va_list ap;
   int i=0;
   MAT **par;
...
extern  int m_resize_vars(int m,int n,...) 
{
   va_list ap;
   int i=0;
   MAT **par;
...
extern  int v_get_vars(va_alist) va_dcl
{
   va_list ap;
   int dim,i=0;
   VEC **par;
...
extern  int iv_get_vars(va_alist) va_dcl
{
   va_list ap;
   int i=0, dim;
   IVEC **par;
...
extern  int m_get_vars(va_alist) va_dcl
{
   va_list ap;
   int i=0, n, m;
   MAT **par;
...
extern  int px_get_vars(va_alist) va_dcl
{
   va_list ap;
   int i=0, dim;
   PERM **par;
...
extern  int v_resize_vars(va_alist) va_dcl
{
   va_list ap;
   int i=0, new_dim;
   VEC **par;
...
extern  int iv_resize_vars(va_alist) va_dcl
{
   va_list ap;
   int i=0, new_dim;
   IVEC **par;
...
extern  int m_resize_vars(va_alist) va_dcl
{
   va_list ap;
   int i=0, m, n;
   MAT **par;
...
extern  int px_resize_vars(va_alist) va_dcl
{
   va_list ap;
   int i=0, new_dim;
   PERM **par;
...
extern  int v_free_vars(va_alist) va_dcl
{
   va_list ap;
   int i=0;
   VEC **par;
...
extern  int iv_free_vars(va_alist) va_dcl
{
   va_list ap;
   int i=0;
   IVEC **par;
...
extern  int px_free_vars(va_alist) va_dcl
{
   va_list ap;
   int i=0;
   PERM **par;
...
extern  int m_free_vars(va_alist) va_dcl
{
   va_list ap;
   int i=0;
   MAT **par;
