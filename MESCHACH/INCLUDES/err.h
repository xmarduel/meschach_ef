...
/*  RCS id: $Id: err.h,v 1.7 2005/12/26 19:24:49 xavier Exp $  */
...
extern	int ev_warn(char *,int,int,char *,int);  /* main error handler */
...
#define warning(err_num,fn_name) ev_warn(__FILE__,err_num,__LINE__,fn_name,0)
