...
static void json_config_PARAMS_graphics_interactiv1D_plots(PARAMS* p, const json_t* config)
{
   ...
   json_array_foreach(SUB_WINDOWS_ARRAY, index, SUB_WINDOW) 
   {
      ...
      p->graph_interactiv1Dplots_params.WINDOW[i][j].X_MIN = json_object_get_real_value(WINDOW, "X_MIN");
      p->graph_interactiv1Dplots_params.WINDOW[i][j].X_MAX = json_object_get_real_value(WINDOW, "X_MAX");
      p->graph_interactiv1Dplots_params.WINDOW[i][j].Y_MIN = json_object_get_real_value(WINDOW, "Y_MIN");
      p->graph_interactiv1Dplots_params.WINDOW[i][j].Y_MAX = json_object_get_real_value(WINDOW, "Y_MAX");
   }
}
...
static void json_config_PARAMS_miscellaneous_graphics(PARAMS* p, const json_t* config)
{
   ...
   if ( json_object_get(MISC_GRAPHICS, "IMTXPROF") )         p->misc_graphics.ispmatpattern    = json_object_get_integer_value(MISC_GRAPHICS, "IMTXPROF");
   if ( json_object_get(MISC_GRAPHICS, "IGEOMVIEW") )        p->misc_graphics.igeomview        = json_object_get_integer_value(MISC_GRAPHICS, "IGEOMVIEW");
   if ( json_object_get(MISC_GRAPHICS, "IGEOMCONTOURVIEW") ) p->misc_graphics.igeomcontourview = json_object_get_integer_value(MISC_GRAPHICS, "IGEOMCONTOURVIEW");
   if ( json_object_get(MISC_GRAPHICS, "IGEOMTOTALVIEW") )   p->misc_graphics.igeomtotalview   = json_object_get_integer_value(MISC_GRAPHICS, "IGEOMTOTALVIEW");
}
