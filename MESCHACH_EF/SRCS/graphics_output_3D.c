...
static char * graphics3D_stokes_script_vtk(const char* filename)
{
   ...
   fprintf(fp, "reader_w.SetFileName( \"./%s_w.vtk\" )\n", filename);
   fprintf(fp, "reader_w.Update()\n");
   fprintf(fp, "reader_s.SetFileName( \"./%s_VV.vtk\" )\n", filename);
   ...
   fprintf(fp, "seeds.SetOrigin(0, 0.0, 0.0)\n");
   fprintf(fp, "seeds.SetPoint2(0, 1.0, 1.0)\n");
   fprintf(fp, "seeds.SetPoint2(0, 0.5, 0.5)\n");
   fprintf(fp, "\n");
   ...
   fprintf(fp, "streamer.SetMaximumPropagation(5)\n");
