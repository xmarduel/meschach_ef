...
#mcstrip ../SRCS/functions_definitions2.c | cyclo -c
#
...
mcstrip ../SRCS/all_params_read.c          | cyclo -c
#
...
#
#mcstrip ../SRCS/splines_1D.c  | cyclo -c 
#mcstrip ../SRCS/time_scheme.c | cyclo -c 
#
#