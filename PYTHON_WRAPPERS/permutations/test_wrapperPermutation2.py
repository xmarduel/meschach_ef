...
px_foutput(stdout, IP); # P = [ 1 ; 2 ; 0 ]
#
print "Corresponding Matrix"
m_foutput(stdout, MIP)
#
print "check MP * MIP :"
ID = m_get(3,3)
m_zero(ID)
...
#sp_foutput(stdout, K2)
print "Permutated Matrix  K3 = P * K1 * P' :"
sp_foutput(stdout, K3)
#
#
#------------------------
