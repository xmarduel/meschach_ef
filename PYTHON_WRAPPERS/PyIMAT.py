...
class IMat:
    ...
    def __add__(self,a):
        ...
        if ( isinstance(a, IMat) ):
            ...
            libmeschach_adds.im_add(self.this, a.this, ret.this)
            return ret
        # a is a integer
    ...
    def __sub__(self,a):
        ...
        if ( isinstance(a, IMat) ):
            ret = IMat(self.m, self.n)
            libmeschach_adds.im_sub(self.this, a.this, ret.this)
            return ret
        # a is a integer
        elif ( isinstance(a, int) ):
            ret = IMat(self.m,self.n)
    ...
    def __mul__(self,a):
        ...
        if ( isinstance(a, IMat) ):
            ret = IMat(self.m, a.n)
            libmeschach_adds.im_mlt(self.this, a.this, ret.this)
            return ret
        # a is a IVec
    ...
    def __iadd__(self,a):
        # a is a IMat
        if ( isinstance(a, IMat) ):
            libmeschach_adds.im_add(self.this, a.this, self.this)
            return self
        # a is a integer
        elif ( isinstance(a, int) ):
    ...
    def __isub__(self,a):
        # a is a IMat
        if ( isinstance(a, IMat) ):
            libmeschach_adds.im_sub(self.this, a.this, self.this)
            return self
        # a is a integer
        elif ( isinstance(a, int) ):
    ...
    def __imul__(self,a):
        ...
        if ( isinstance(a, IMat) ):
            tmp = + self
            libmeschach_adds.im_mlt(tmp.this, a.this, self.this)
            return self
        # a is a integer
        elif ( isinstance(a, int) ):
