 ...
 */
void
copytranspose(Matrix a, Matrix b)
{
	int	i, j;
 ...
 */
void
mult4x4(register Matrix a, register Matrix b, register Matrix c)
{
 ...
 * postmultmatrix
 *
 * Postmultipy the top matrix on the stack by "mat"
 *
 */
void
postmultmatrix(Matrix mat)
{
	Matrix	prod;
	float	*m;
	Token	*p;
	...
	/*
	 * Should be done in line for better speed...
	 */
	mult4x4(prod, vdevice.transmat->m, mat);
	loadmatrix(prod);
}
 ...
 */
void
multvector(Vector v, Vector a, Matrix b)
{
 ...
 */
void
premultvector(Vector v, Vector a, Matrix b)
{
