#
# Makefile for VOGLE 
# This one is setup specifically for SUN Solaris2.x
#
# Usage: make
#
...
#
#DEVICES = -DPOSTSCRIPT -DHPGL -DDXY -DTEK -DX11 -DPPM
#DOBJS = ../drivers/ps.o ../drivers/hpdxy.o ../drivers/tek.o ../drivers/X11.o ../drivers/ppm.o
DEVICES = -DX11 -DPOSTSCRIPT -DPPM -DHPDXY
DOBJS = ../drivers/X11.o ../drivers/ps.o ../drivers/ppm.o ../drivers/hpdxy.o
...
#
#  SUN4/Solaris
CFLAGS = -DSYS5 -g -Xc -v -I/usr/openwin/include
#CFLAGS = -DSYS5 -g -I/usr/openwin/include
...
PAS = pc
#
# You also define your pc flags here too. These are the ones we used on sun
#
# The usual default...

#
PFLAGS = -g -w /usr/lib/libm.il
...
all:
	...
	cd examples/xview; make -f Makefile \
			...
			MCFLAGS="$(MCFLAGS)" \
			CC="$(CC)"
	cd examples/xt; make -f Makefile \
			LIBS="$(LIBS)" \
			MCFLAGS="$(MCFLAGS)" \
			CC="$(CC)"
	...
	if test -n "$(PAS)" ; \
	then cd examples/pas; make -f Makefile \
			LIBS="$(LIBS)" \
			MPFLAGS="$(MPFLAGS)" \
			PAS="$(PAS)" ; \
	fi ; exit 0
