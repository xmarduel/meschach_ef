 ...
 * http://www.cise.ufl.edu/research/sparse/umfpack, or use the amd_transpose
...
/* amd_transpose: sorts, transposes, and removes duplicate entries from the
 ...
 * Ap [0] must still be zero, and Ap must be monotonically nondescreasing.
